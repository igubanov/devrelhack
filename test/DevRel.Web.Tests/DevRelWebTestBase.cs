...
{
    public abstract class DevRelWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DevRelWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DevRelWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DevRelDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DevRelDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DevRelDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DevRelDbContext, Task<T>> func)
        {
            T result;
